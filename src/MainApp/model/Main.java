...
public class Main {
    public static void main(String[] args) {
        ...
        // Tạo sách mới
        Book newBook = new Book("B008", "Effective Java", "path/to/image3.jpg", "Joshua Bloch", "Programming", "English", 20, "Available", "B1");
        ...
        Student newStudent = new Student("S001", "Tèo", "23020700@vnu.edu.vn", "12345", "0374169035");
